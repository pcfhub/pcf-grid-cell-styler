...
// Longest first, so `GridCellStyler` cannot eat the front of a longer token that
 ...
 * the script has no second act here — and it carries a literal GridCellStyler in
